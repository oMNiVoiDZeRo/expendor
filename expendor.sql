...
INSERT INTO `users` (`id`, `username`, `password`, `created_at`, `categories`, `bills`, `currencies`) VALUES
(14, 'asdf', '$2y$10$MWLqDBHjjktndyayviazyOdinA5TA24nqep8wyQ4wh.qOAa36brqG', '2021-08-04 08:06:01', 'Income,Food,Health,Home,Auto,Insurance,Utility,Debt,Work,Entertainment', 'Rent,Electric,Utility,Home Insurance,Health Insurance,Car Insurance,Phone,Loan,Internet,Web Hosting,Medical,This is not a bill.', 'usd,eur,btc'),
(10, 'test', '$2y$10$6o6TvcMnnmfs9uRJVA0hxugpJw5uM.DFz2dr6E2gAFF6xgwxvjIPm', '2021-08-03 14:04:20', 'Income,Food,Health,Home,Auto,Insurance,Utility,Debt,Work,Entertainment', 'Rent,Electric,Utility,Home Insurance,Health Insurance,Car Insurance,Phone,Loan,Internet,Web Hosting,Medical,Payroll,This is not a bill.', 'usd');
COMMIT;
